...
abstract class DateTimeFormator {
  static String _zeroPad(int value) => value < 10 ? '0$value' : '$value';

  static String formatDateTime(DateTime dt) =>
      formatTime(TimeOfDay(hour: dt.hour, minute: dt.minute)) +
      ', ' +
      formatDate(dt);
  ...
  static String timespan(DateTime datetime,
      {DateTime otherDateTime, int units: 1}) {
