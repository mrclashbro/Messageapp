    ...
    return AppBar(
      ...
      actions: <Widget>[
        GestureDetector(
          ...
          onTap: _isMessageEditable()
              ? null
              : () {
                  Navigator.push(
                    context,
                    MaterialPageRoute<bool>(
                        builder: (context) => CreateOrEditSmsMessagePage(
                            MessageMode.edit, _message)),
                  ).then((bool result) async {
                    final Message message = await MessageProvider.getInstance()
                        .getMessage(_message.id);
          ...
          child: GestureDetector(
              ...
              onTap: () async {
                await DialogProvider.showConfirmation(
                    ...
                    content:
                        Text('Are you really want to delete this message?'),
                    onYes: () async {
                      if (await MessageProvider.getInstance()
                          .removeMessage(_message.id))
                            ...
                            children: <TableRow>[
                              ...
                              TableRow(children: [
                                Text('Created:',
                                    style:
                                        TextStyle(fontWeight: FontWeight.bold)),
                                Text(DateTimeFormator.formatDateTime(
